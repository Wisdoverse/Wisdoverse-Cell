"""Ports for channel gateway event outbox persistence."""
...
class ChannelGatewayEventOutboxStore(Protocol):
    """Persistence port for channel gateway integration-event outbox operations."""
