"""Ports for coordinator event outbox persistence."""
...
class CoordinatorEventOutboxStore(Protocol):
    """Persistence port for Coordinator integration-event outbox operations."""
