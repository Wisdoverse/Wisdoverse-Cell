...
from agents.dev_agent.core.workflow_validator import WorkflowValidator
...
def test_valid_plan_passes(validator):
    plan = _make_plan([
        WorkflowNode(
            name="plan",
            config={
                "prompt": "Edit agents/dev_agent/core/prompts.py",
                "tags": ["plan"],
            },
        ),
        WorkflowNode(
            ...
            dependsOn=["plan"],
            config={
                "prompt": "Update agents/dev_agent/core/workflow_validator.py",
                "tags": ["implement"],
            },
        ),
        WorkflowNode(
            ...
            dependsOn=["impl"],
            config={
                "prompt": "Review agents/dev_agent/tests/unit/test_workflow_validator.py",
                "tags": ["review"],
            },
        ),
        WorkflowNode(
            ...
            config={
                "prompt": (
                    "Verify agents/dev_agent/tests/unit/test_workflow_validator.py "
...
def test_last_node_without_git_push_rejected(validator):
    plan = _make_plan([
        ...
        WorkflowNode(
            ...
            dependsOn=["plan"],
            config={
                "prompt": "Review agents/dev_agent/core/workflow_validator.py",
                "tags": ["review"],
            },
        ),
        WorkflowNode(
            ...
            dependsOn=["review"],
            config={
                "prompt": "Run pytest agents/dev_agent/tests/unit/test_workflow_validator.py -q",
                "tags": ["acceptance"],
            },
        ),
    ])
