...
class TestSessionTimeoutPlugin:
    ...
    async def test_skips_when_disabled(self):
        from agents.requirement_manager.app.plugins.session_timeout import SessionTimeoutPlugin
...
class TestChannelRegistryPlugin:
    ...
    async def test_no_channels_returns_empty(self):
        from agents.requirement_manager.app.plugins.channel_registry import ChannelRegistryPlugin
