...
@pytest.fixture
def executor():
    from agents.gateways.user_interaction.core.tools import ToolExecutor
    return ToolExecutor
...
@pytest.mark.asyncio
async def test_get_work_packages(executor):
    ...
    with patch("agents.gateways.user_interaction.core.tools.get_op_client", return_value=mock_op):
