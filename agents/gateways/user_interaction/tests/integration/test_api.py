...
def test_app(mock_agent):
    ...
    with patch("agents.gateways.user_interaction.app.main.agent", mock_agent), \
         patch("agents.gateways.user_interaction.api.webhook.get_agent", return_value=mock_agent):
        from agents.gateways.user_interaction.app.main import app
        yield app
