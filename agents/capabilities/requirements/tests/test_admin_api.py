...
class TestLLMUsageAPI:
    ...
    async def test_get_llm_usage_default_date(self):
        ...
        with patch("agents.capabilities.requirements.app.main.agent") as mock_main_agent, \
             patch("agents.capabilities.requirements.api.admin.LLMUsageRepository") as MockRepo:
...
class TestCircuitBreakerAPI:
    ...
    async def test_get_circuit_breaker_status(self):
        ...
        with patch("agents.capabilities.requirements.app.main.agent") as mock_main_agent, \
             patch("agents.capabilities.requirements.api.admin.llm_gateway") as mock_gateway:
