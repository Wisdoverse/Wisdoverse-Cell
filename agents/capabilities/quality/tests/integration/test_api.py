...
from agents.capabilities.quality.app.main import app
from agents.capabilities.quality.models.schemas import (
...
async def test_trigger_run_success(auth_headers):
    ...
    with patch("agents.capabilities.quality.api.qa.get_agent", return_value=mock_agent):
