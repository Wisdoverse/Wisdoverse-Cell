...
from agents.capabilities.project_management.core.report_service import ReportService
...
class TestGenerateReports:
    @pytest.mark.asyncio
    @patch("agents.capabilities.project_management.core.report_service.settings")
