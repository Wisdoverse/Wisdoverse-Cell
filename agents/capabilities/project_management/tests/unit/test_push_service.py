...
@pytest.fixture
def push_service():
    from agents.capabilities.project_management.core.push_service import PushService
...
async def test_push_alerts_success(push_service):
    ...
    with (
        patch("agents.capabilities.project_management.core.push_service.settings") as mock_settings,
        patch("agents.capabilities.project_management.core.push_service.get_feishu_client") as mock_get_client,
    ):
...
async def test_push_alerts_no_chat_id(push_service):
    ...
    with patch("agents.capabilities.project_management.core.push_service.settings") as mock_settings:
