...
def test_app(mock_agent):
    ...
    with (
        patch("agents.capabilities.project_management.api.pm.get_agent", return_value=mock_agent),
        patch("agents.capabilities.project_management.app.main.agent", mock_agent),
    ):
        from fastapi import FastAPI
        from fastapi.responses import JSONResponse

        from agents.capabilities.project_management.api.pm import router as pm_router
