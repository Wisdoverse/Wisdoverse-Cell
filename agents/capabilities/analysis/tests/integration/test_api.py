...
def test_app(mock_agent):
    ...
    with patch("agents.capabilities.analysis.api.analysis.get_agent", return_value=mock_agent), \
         patch("agents.capabilities.analysis.app.main.agent", mock_agent):

        from fastapi import FastAPI
        from fastapi.responses import JSONResponse

        from agents.capabilities.analysis.api.analysis import router as analysis_router
