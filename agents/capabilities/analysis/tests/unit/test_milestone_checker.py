...
def checker(mock_bitable):
    from agents.capabilities.analysis.core.milestone_checker import MilestoneChecker
...
async def test_check_no_tasks(checker, mock_bitable):
    ...
    with patch("agents.capabilities.analysis.core.milestone_checker.settings") as mock_settings:
...
async def test_push_risks_success(checker):
    ...
    with patch("agents.capabilities.analysis.core.milestone_checker.settings") as mock_settings, \
         patch("agents.capabilities.analysis.core.milestone_checker.get_feishu_client") as mock_get_client:
