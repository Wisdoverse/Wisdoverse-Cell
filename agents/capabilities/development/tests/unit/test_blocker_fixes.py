...
from agents.capabilities.development.core.workflow_validator import ValidationResult
from agents.capabilities.development.db.repository import (
    DevTaskRepository,
...
class TestStartupDoesNotCrash:
    ...
    async def test_on_startup_uses_create_tables_not_initialize(self):
        ...
        from agents.capabilities.development.app import main as main_module
    ...
    async def test_reconcile_publishes_completion_events(self):
        ...
        try:
            ...
            with (
                ...
                patch(
                    "agents.capabilities.development.core.result_collector.ResultCollector",
...
class TestChildTaskUniqueIDs:
    ...
    async def test_handle_tasks_ready_creates_separate_records(self):
            ...
            return_value=WorkflowPlan(
                ...
                nodes=[
                    WorkflowNode(
                        name="plan",
                        config={
                            "prompt": "Edit agents/capabilities/development/service/agent.py",
                            "tags": ["plan"],
                        },
                    ),
                    WorkflowNode(
                        ...
                        config={
                            "prompt": (
                                "Verify agents/capabilities/development/service/agent.py and "
        ...
        with (
            ...
            patch(
                "agents.capabilities.development.service.agent.DevWorkflowLogRepository",
...
class TestTaskDurationMetric:
    ...
    async def test_task_duration_observed_on_completion(self):
        ...
        from agents.capabilities.development.core.result_collector import ResultCollector
        ...
        with patch("agents.capabilities.development.core.result_collector.TASK_DURATION") as mock_metric:
...
class TestSecurityScannerPath:
    @pytest.mark.asyncio
    async def test_result_collector_passes_cwd_to_scanner(self):
        """ResultCollector should pass '.' to scanner, not a branch name."""
        from agents.capabilities.development.core.result_collector import ResultCollector
