...
from agents.capabilities.development.models.schemas import (
    RiskLevel,
    SanitizedTask,
    WorkflowNode,
    WorkflowPlan,
)
from agents.capabilities.development.service import agent as agent_module
...
async def test_plan_and_execute_injects_project_id_before_submit():
    ...
    sanitized = SanitizedTask(
        ...
        estimated_hours=2,
        wp_id=321,
        related_files=["agents/capabilities/development/service/agent.py"],
    ...
    plan = WorkflowPlan(
        ...
        nodes=[
            ...
            WorkflowNode(
                ...
                dependsOn=["plan"],
                config={
                    "prompt": "Verify agents/capabilities/development/service/agent.py",
                    "tags": ["acceptance"],
                },
            ),
        ],
