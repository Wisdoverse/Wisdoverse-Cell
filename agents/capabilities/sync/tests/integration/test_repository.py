...
from agents.capabilities.sync.db.repository import (
...
async def test_acquire_expired_lock(db_session):
    ...
    from agents.capabilities.sync.models.sync import SyncLock
...
async def test_create_and_complete_log(db_session):
    ...
    from agents.capabilities.sync.models.sync import SyncLog
