...
from shared.integrations.feishu.services import session_manager as _sm_mod
from shared.integrations.feishu.services.session_manager import SessionManager
