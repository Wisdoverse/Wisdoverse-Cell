...
def checker(mock_bitable, mock_messenger):
    ...
    return MilestoneChecker(bitable=mock_bitable, messenger=mock_messenger)
...
async def test_check_no_tasks(checker, mock_bitable):
    ...
    with patch("shared.capabilities.analysis.core.milestone_checker.settings") as mock_settings:
