...
The `evolution-agent` (L2) runs on a separate schedule, analyzing traces across all agents to propose architectural improvements. See `agents/evolution_agent/README.md`.
